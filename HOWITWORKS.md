...
Этот раздел я вскоре заполню, когда пойму как авторизоваться во внутренней почте. По всей видимости нужно сначала запросить обновление токена ESRNSec, отправив запрос GET на `https://asurso.ru/asp/Messages/MailBox.asp?at=[at]&ver=[ver]` и только после этого запрашивать методы почты
